...
void GPIO_DeInit(unsigned int * gpio_x)
{
  ...
  if (gpio_x == GPIO_A)
  {
    // activer le forcer reset GPIOA 
    // ...
    
    // deactiver le forcer reset GPIOA 
    // ...
...
void GPIO_Init(unsigned int * gpio_x, char Mode, char typeOutput, short int pin)
{
  ...
  // Determiner la valeur de masque moder et préparer la configureation de register moder
  //...
  
  // configurer le register Moder
  //...
  
  // Determiner la valeur de masque PP et préparer la configureation de register PP
  //...
  
  // configuere la mode PP
  //...   
...
unsigned  char GPIO_ReadInputDataBit(unsigned int *  gpio_x, unsigned  short int GPIO_Pin)
{
  ...
  // Tester si valeur du pin est !=0x00
  //...
  // retouner l
  //...
  
  // sinon Tester si valeur du pin est !=0x00
  //...
  //retouner 0
  //...
}
...
{
  // ecrire la valeur PortVal dans le port
  //...
}
